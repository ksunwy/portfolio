...
const header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 flex flex-row items-center justify-between w-full px-12 py-10 z-10 header-bg">
      ...
      <a target="_blank" href="https://t.me/ksunnw" className="px-8 py-6 font-black uppercase font-bold text-white bg-[#89B0EA] rounded-lg flex items-center justify-center cursor-pointer">
        Reach me
      </a>
    </header>
  )
